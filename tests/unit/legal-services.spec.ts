...
describe('Legal Services', () => {
  ...
  it('fetches filing by id correctly', async () => {
    ...
    // mock endpoint
    get.withArgs('https://business-api.url/businesses/CP1234567/filings/1234')
  ...
  it('deletes filing by id correctly', async () => {
    // mock endpoint
    del.withArgs('https://business-api.url/businesses/CP1234567/filings/1234')
  ...
  it('updates a filing correctly', async () => {
    ...
    // mock endpoint
    put.withArgs('https://business-api.url/businesses/CP1234567/filings/1234?draft=true')
      .returns(Promise.resolve({ data: { filing: FILING } }))
  ...
  it('creates an alteration correctly', async () => {
    ...
    // mock endpoint
    post.withArgs('https://business-api.url/businesses/CP1234567/filings?draft=true')
  ...
  it('fetches business info correctly', async () => {
    ...
    // mock endpoint
    get.withArgs('https://business-api.url/businesses/CP1234567')
  ...
  it('fetches name translations correctly', async () => {
    ...
    // mock endpoint
    get.withArgs('https://business-api.url/businesses/CP1234567/aliases')
  ...
  it('fetches incorporation address correctly', async () => {
    ...
    // mock endpoint
    get.withArgs('https://business-api.url/businesses/CP1234567/addresses')
  ...
  it('fetches directors correctly', async () => {
    ...
    // mock endpoint
    get.withArgs('https://business-api.url/businesses/CP1234567/directors')
  ...
  it('fetches parties correctly', async () => {
    ...
    // mock endpoint
    get.withArgs('https://business-api.url/businesses/CP1234567/parties')
  ...
  it('fetches share structure correctly', async () => {
    ...
    // mock endpoint
    get.withArgs('https://business-api.url/businesses/CP1234567/share-classes')
  ...
  it('fetches resolutions correctly', async () => {
    ...
    // mock endpoint
    get.withArgs('https://business-api.url/businesses/CP1234567/resolutions')
  ...
  it('fetches name request correctly', async () => {
    ...
    // mock endpoint
    get.withArgs('https://business-api.url/nameRequests/NR1234567/validate?phone=&email=')
  ...
  it('fetches business document correctly', async () => {
    ...
    get.withArgs('https://business-api.url/businesses/CP1234567/documents').returns(Promise.resolve({ data: {
      ...BUSINESS_DOCUMENTS } }))
  ...
  it('handles errors as expected', async () => {
    ...
    get.withArgs('https://business-api.url/businesses/CP1234567/filings/1234').returns(Promise.resolve({}))
    ...
    del.withArgs('https://business-api.url/businesses/CP1234567/filings/1234').returns(Promise.reject(new Error()))
    ...
    get.withArgs('https://business-api.url/businesses/CP1234567').returns(Promise.resolve({}))
    ...
    get.withArgs('https://business-api.url/businesses/CP1234567/aliases').returns(Promise.resolve({}))
    ...
    get.withArgs('https://business-api.url/businesses/CP1234567/directors').returns(Promise.resolve({}))
    ...
    get.withArgs('https://business-api.url/businesses/CP1234567/parties').returns(Promise.resolve({}))
    ...
    get.withArgs('https://business-api.url/businesses/CP1234567/share-classes').returns(Promise.resolve({}))
    ...
    get.withArgs('https://business-api.url/businesses/CP1234567/resolutions').returns(Promise.resolve({}))
    ...
    get.withArgs('https://business-api.url/nameRequests/NR1234567/validate?phone=&email=').returns(Promise.resolve({}))
    ...
    get.withArgs('https://business-api.url/businesses/CP1234567/documents').returns(Promise.resolve({}))
